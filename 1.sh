#!/usr/bin/bash
#
#           CasaOS Installer Script v0.4.2#
...
"${CASA_DOWNLOAD_DOMAIN}IceWhaleTech/CasaOS-AppManagement/releases/download/v0.4.2-1/linux-${TARGET_ARCH}-casaos-app-management-v0.4.2-1.tar.gz"
...
"${CASA_DOWNLOAD_DOMAIN}IceWhaleTech/CasaOS-UI/releases/download/v0.4.2-1/linux-all-casaos-v0.4.2-1.tar.gz" 
    )
}
